...
public class BoardCategory {
	...
	private String categoryDescrription;
	...
	public String getCategoryDescrription() {
		return categoryDescrription;
	}
	public void setCategoryDescrription(String categoryDescrription) {
		this.categoryDescrription = categoryDescrription;
	}
	...
	public String toString() {
		return "BoardCategory [categoryId=" + categoryId + ", categoryClass1=" + categoryClass1 + ", categoryClass2="
				+ categoryClass2 + ", categoryName=" + categoryName + ", categoryDescrription=" + categoryDescrription
