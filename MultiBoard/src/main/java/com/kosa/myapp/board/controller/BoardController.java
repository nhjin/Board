...
public class BoardController {
	...
	public String getBoardDetails(@PathVariable int boardId, @PathVariable int page, 
			Model model) {
	...
	public String writeArticle(Board board, BindingResult result, RedirectAttributes redirectAttrs) {
		...
		try {
			...
			board.setReadCount(Jsoup.clean(board.getContent(), WhiteList.basic()));
	...
	public String ReplyArticle(Board board, BindingResult result, 
	...
	public String deleteArticle(@PathVariable int boradId, Model model) {
	...
	public String deleteArticle(Board board, BindingResult result, 
			HttpSession session, Model model) {
		try {
