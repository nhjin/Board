<%@page import="com.kosa.myapp.board.service.impl.BoardCategoryService"%>
<%@page import="java.util.List"%>
<%@page import="com.kosa.myapp.board.model.BoardCategory"%>
<%@page import="com.kosa.myapp.board.service.IBoardCategoryService"%>
